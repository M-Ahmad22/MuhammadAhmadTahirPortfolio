  ...
  return (
    <section className="section-padding bg-background">
      <div className="container-elegant">
        ...
        {/* Certifications Grid with Meteors */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
          {certifications.map((cert, index) => (
            ...
            >
              <Card className="border-elegant glass-elegant card-hover h-full relative overflow-hidden">
                {/* Meteors Effect */}
                <Meteors number={3} />
        ...
        >
          {[
            ...
            <Card key={index} className="border-elegant glass-elegant text-center relative overflow-hidden">
              <Meteors number={2} />
...
export default MeteorCertifications;